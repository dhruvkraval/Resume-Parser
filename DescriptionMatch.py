...
def resume_rating(resumeInput, jobDescInput):
    resume = resumeInput
    job = jobDescInput
    ...
    return percent_match.rating(matchPercentage)

# to get the list of suggestions return suggestions.suggestions(job,resume)
